    ...
    sections: [
      {
        ...
        title: '01. Webの仕組み',
        lessons: [
          { id: 'l1', title: 'HTTPとクライアント/サーバー', type: 'video', duration: '12:40', status: 'done' },
          { id: 'l2', title: 'DNS・URL・ブラウザレンダリング', type: 'video', duration: '09:20', status: 'done' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'l10', title: '関数とスコープ', type: 'video', duration: '19:30', status: 'active', progress: 42 },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'l15', title: 'Web IDE: ToDoアプリ実装', type: 'code', duration: '提出', status: 'locked' },
