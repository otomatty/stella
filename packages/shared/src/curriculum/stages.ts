...
export const stages: StageInfo[] = [
  ...
  },
  {
    ...
    label: "S1 文法体験",
    shortLabel: "1 問 1 構文",
    description: "1 問につき 1 つの構文だけに絞って、 変数・数値・文字列・配列を一度ずつ体験する。",
    defaultTestKind: "stdout",
  ...
  },
  {
    ...
    description: "既に習った構文を組み合わせ、 条件分岐・ループ・関数まで広げて使えるようにする。",
    defaultTestKind: "stdout",
  ...
  },
  {
    ...
    label: "S3 ロジック入門",
    shortLabel: "関数を組み立てる",
    description: "関数を作って値を返す、 短いプログラムを自力で組み立てられるようにする。",
  ...
  },
  {
    ...
    label: "S4 アルゴリズム",
    shortLabel: "効率を意識する",
    description: "計算量やデータ構造を意識して、 複数の手順を組み合わせた処理を解く。",
    defaultTestKind: "function",
  ...
  },
  {
    ...
    label: "S5 設計演習",
    shortLabel: "全体を設計する",
    description: "複数の概念を統合し、 少し大きな仕様を自分で分割して実装する。",
    defaultTestKind: "function",
