# @falcon/content — TypeScript入門研修 教材
...
教材は**モジュール / レッスン / トピック**の3層で、全10モジュール(M0〜M9)/ 42レッスン / 162トピックです。
...
| [CURRICULUM.md](CURRICULUM.md) | 全体構成・全トピックの一覧・順序の根拠 |
| [IMAGE_PLAN.md](IMAGE_PLAN.md) | イメージ画像の配置計画 |
