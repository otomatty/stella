...
const colorClass: Record<StageColor, string> = {
...
interface StageThumbProps {
  ...
  label?: string;
  /**
   * サムネイル画像の R2 パス (`stages.thumbnail_path`)。 正本は教材リポジトリの
...
export const StageThumb = ({
  ...
  // 失敗を boolean で持つと、同じインスタンスが別ステージのパスを受け取ったとき
